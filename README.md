...
**dev 와 test 의 차이(과잉 전환 20.0% → 34.6%)가 튜닝 과적합의 크기다.** 이 test 셋은 이제 한 번 사용했으므로 추가 개선 사항은 새 test 셋으로 평가한다.
...
오답 13건의 원인 분석과 추가 개선 사항 계획은 **[평가 보고서](docs/evaluation.md)** 에 있다.
